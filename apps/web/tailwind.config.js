  ...
  theme: {
    extend: {
      colors: {
        ...
        // Skin semantic tokens — utilities (bg-term, text-ink, border-line,
        // text-amber…) resolve to the --t-* custom properties in styles.css,
        // which flip with html[data-theme] / html.dark, so utilities carry
        // the theme swap for free, no dark: variants.
        paper: 'var(--t-bg)',
        term: 'var(--t-term)',
        panel: 'var(--t-panel)',
        sel: 'var(--t-sel)',
