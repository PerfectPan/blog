      ...
      >
        ...
        <section className='rounded-md border border-dashed border-border bg-secondary p-4 grid gap-4'>
          <label className='grid'>
            ...
            <input
              className='w-full rounded-lg border border-border bg-background px-2.5 py-2 text-sm text-foreground outline-none placeholder:text-muted-foreground/60 focus:border-primary focus:shadow-[0_0_0_2px_color-mix(in_srgb,var(--primary)_15%,transparent)]'
              value={fields.title}
          ...
          <label className='grid'>
            ...
            <textarea
              className='w-full rounded-lg border border-border bg-background px-2.5 py-2 text-sm text-foreground outline-none placeholder:text-muted-foreground/60 focus:border-primary focus:shadow-[0_0_0_2px_color-mix(in_srgb,var(--primary)_15%,transparent)] min-h-16 resize-y'
        ...
        <div className='flex items-center gap-3'>
          ...
          {mode === 'edit' ? (
            <button
              ...
              disabled={saving}
              className='cursor-pointer rounded-lg border border-[color-mix(in_srgb,var(--destructive)_45%,transparent)] bg-secondary px-3.5 py-1.75 text-sm text-destructive transition-[border-color,color] duration-100 hover:border-destructive hover:bg-[color-mix(in_srgb,var(--destructive)_10%,transparent)] hover:text-destructive'
            >
              删除
            </button>
          ) : null}
