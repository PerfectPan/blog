...
export function TagInput({
  ...
  return (
    <div className='grid gap-2'>
      ...
      <div
        className='flex cursor-text flex-wrap items-center gap-1.5 rounded-lg border border-border bg-background px-2.5 py-1.5 focus-within:border-primary focus-within:shadow-[0_0_0_2px_color-mix(in_srgb,var(--primary)_15%,transparent)]'
        onMouseDown={(event) => {
